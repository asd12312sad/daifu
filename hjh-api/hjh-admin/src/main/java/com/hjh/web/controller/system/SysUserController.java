...
import com.hjh.system.service.ISysPostService;
...
public class SysUserController extends BaseController {
    ...
    public SysAjaxResult getInfo(@PathVariable(value = "userId", required = false) Long userId) {
    ...
    public SysAjaxResult authRole(@PathVariable("userId") Long userId) {
        SysAjaxResult ajax = SysAjaxResult.success();
