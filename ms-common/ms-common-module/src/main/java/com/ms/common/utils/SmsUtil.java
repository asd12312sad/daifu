...
public class SmsUtil {
    ...
    private static final String ACCESS_KEY_ID = "LTAI5tGc87Z2sYLHDi4evw4u";
    private static final String ACCESS_SECRET = "MadkBkRllfAxXHsNAr1rn9p3fkPis0";
    private static final String SIGN_NAME = "小飞象";
