<template>
  <div class="app-container">
    ...
    <el-table  border :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="付款者地址" align="center" prop="payAddress" show-overflow-tooltip/>
      ...
      <el-table-column label="结果" align="center" prop="result">
        ...
        <template slot-scope="scope">
          {{ resultFormat(scope.row) ? resultFormat(scope.row) : scope.row.result }}
        </template>
      </el-table-column>
      <el-table-column label="玩家结果" align="center" prop="userResult"/>
      <el-table-column label="系统结果" align="center" prop="systemResult"/>
      <el-table-column label="充币数量" align="center" prop="amount"/>
      <el-table-column label="玩家盈利" align="center" prop="profit"/>
      <el-table-column label="一级代理分红" align="center" prop="proxyOneAmount"/>
      <el-table-column label="二级代理分红" align="center" prop="proxyTwoAmount"/>
      <el-table-column label="反水金额" align="center" prop="fanshuiAmount"/>
      <el-table-column label="U盾手续费" align="center" prop="fee"/>
      <el-table-column label="充币地址" align="center" prop="address" show-overflow-tooltip/>
      <el-table-column label="创建时间" align="center" prop="createDate" width="180">
      </el-table-column>
      <el-table-column label="交易HASH" align="center" prop="txId" show-overflow-tooltip/>
      <el-table-column label="反水状态" align="center" prop="fanshui">
        <template slot-scope="scope">
          {{ danshuiFormat(scope.row) ? danshuiFormat(scope.row) : scope.row.fanshui }}
        </template>
      </el-table-column>
      <el-table-column label="推广返佣状态" align="center" prop="tuiguang">
        <template slot-scope="scope">
          {{ tuiguangFormat(scope.row) ? tuiguangFormat(scope.row) : scope.row.tuiguang }}
        </template>
      </el-table-column>
      <el-table-column label="一级代理名称" align="center" prop="proxyOneName"/>
      <el-table-column label="二级代理名称" align="center" prop="proxyTwoName"/>
