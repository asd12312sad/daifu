<template>
  <div>
    <el-card class="box-card">
      ...
      <div class="tabswitch">
        <div class="left lefttabactive">代付订单</div>
        <div class="left" @click="getlinks">代收订单</div>
      </div>
      <div class="tablemain">
        <el-table
          ref="singleTable"
        ...
        <el-table-column label="手续费" align="center" width="140" prop="feeAmount" />
          ...
          <el-table-column label="回调信息" align="center" prop="returnMsg" width="200">
            <template slot-scope="scope">
              <span>
                {{
          ...
          <el-table-column label="回调状态" align="center" prop="status"  width="140">
            <template slot-scope="scope">
              <span>
                {{ scope.row.returnStatus | filterReturnStatus }}
              </span>
            </template>
          </el-table-column>
          ...
          <el-table-column label="日志记录" align="center" prop="message" width="160">
            <template slot-scope="scope">
              <span>
                {{
          ...
          <el-table-column label="拒绝理由" align="center" prop="refuseMsg" width="160" />
    ...
    getList() {
      ...
      this.$apiFun.payOrderabnormitylist(this.queryParams).then((result) => {
        if (result.code == 200) {
          ...
          Bus.$emit("advanced", this.queryParams.total);
        }
      });
    },
